...
type SerializedTrackFeatures = SerializeFrom<TrackFeatures>;
...
export const formatters: Partial<FormatterFunctions<SerializedTrackFeatures>> =
  {
...
export const readableFeatures = (
  features: SerializedTrackFeatures
): [string, React.ReactNode][] =>
  Object.entries(features).flatMap(([_key, value]) => {
    const key = _key as keyof SerializedTrackFeatures;
